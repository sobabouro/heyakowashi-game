...
public class ActSubdivide3 {
    ...
    public class SurfaceGeometry {
        ...
        public void Add(
            ...
            bool isFound1;
            // 時計回り DB の中に自身の toward を終点とする連結辺がある場合
            ...
            bool isFound2;
            // 反時計回り DB の中に自身の away を始点とする連結辺がある場合
            ...
            if (isFound1) {
                ...
                if (isFound2) {
                    ...
                    // それぞれのループを更新
                    clockwiseDB[roop1.endPos] = roop1;
                    counterclockwiseDB[roop1.startPos] = roop1;
                }
                // 時計回り DB 繋がったとき、自身の away をキーとする roop1 を追加する
                else {
                    roop1.end = away_node;
                ...
                // 反時計回 DB に繋がったとき，自身の toward をキーとする roop2 を追加する
                if (isFound2) {
