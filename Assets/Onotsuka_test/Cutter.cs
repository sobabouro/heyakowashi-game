...
public class Cutter : MonoBehaviour
{
    ...
    {
        /*
        var meshCut = other.gameObject.GetComponent<RondomSubdivision>();
        ...
        meshCut.CutMesh(other, other.transform, );
        */
        ...
        // 動きで切断する場合の平面
        var cutPlaneNormal = Vector3.Cross(transform.forward.normalized, prePos - transform.position).normalized;
        var cutPlaneAnchor = transform.position;

        // 切断処理
        var targetMesh = other.GetComponent<MeshFilter>().mesh;
        var (frontMesh, backMesh) = RondomSubdivision.CutMesh(
            targetMesh,
            other.transform,
            cutPlaneAnchor,
            cutPlaneNormal
